...
IocpHttpd::IocpHttpd()
{
	...
	SetStatic("\/static\/*", "c:\\www2\\static\\");
	//SetHomeDir("C:\\Users\\bgonzales\\Documents\\GitHub\\iocphttpd\\websitecarconfig\\www");
...
void IocpHttpd::HandleHome(HttpRequest *httpRequest, HttpResponse *httpResponse)
{
	...
	{
		httpResponse->AddTemplate("Home", "C:\\www2\\index.html");
	}
...
void IocpHttpd::HandleTest(HttpRequest *httpRequest, HttpResponse *httpResponse)
{
	...
	{
		httpResponse->AddTemplate("Test", "C:\\www2\\test.html");
	}
...
void IocpHttpd::HandleInit(HttpRequest *httpRequest, HttpResponse *httpResponse)
{
	...
	{
		httpResponse->AddTemplate("init", "C:\\www2\\init.html");
	}
